...
<body>
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="/">首页</a></li>
															                    <li class="nav-item" role="presentation"><a class="nav-link " href="http://10.119.9.215/shangpin.html">商品</a></li>
																									                    ...
																									                    <li class="nav-item" role="presentation"><a class="nav-link " href="http://10.119.9.215/msg.html">留言</a></li>
    ...
    <main class="page landing-page">
	   <section class="clean-block clean-hero" style="background-image:url('/static/default/assets/img/tech/image4.jpg');color:rgba(9, 162, 255, 0.85);">
            <div class="text">
                <h2>极致CMS建站系统</h2>
                <p>开源免费，无商业授权，仅需记住几个简单的模板标签，小白也能搭建一个简单的网站，让你简单快乐的工作。</p><a href="http://10.119.9.215/guanyu.html" target="_blank"><button class="btn btn-outline-light btn-lg" type="button">了解更多</button></a></div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        </div><a href="http://10.119.9.215/guanyu.html"><button class="btn btn-outline-primary btn-lg" type="button">立刻了解</button></a></div>
                </div>
            </div>
        </section>
	<div class="projects-horizontal">
        ...
        <div class="container">
            ...
            <div class="row projects">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-5"><a href="http://10.119.9.215/xinwenfenleiyi/21.html"><img class="img-fluid" src="/static/default/assets/img/desk.jpg"></a></div>
                        <div class="col">
			                ...
			                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5"><a href="http://10.119.9.215/xinwenfenleier/26.html"><img class="img-fluid" src="/static/default/assets/img/desk.jpg"></a></div>
                        <div class="col">
                            <h3 class="name">极致CMS新闻测试标题</h3>
                            <p class="description">极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新...</p>
                        </div>
			                ...
			                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5"><a href="http://10.119.9.215/xinwenfenleisi/8.html"><img class="img-fluid" src="/static/default/assets/img/desk.jpg"></a></div>
                        <div class="col">
                            <h3 class="name">极致CMS新闻测试标题</h3>
                            <p class="description">极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新...</p>
                        </div>
			                ...
			                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5"><a href="http://10.119.9.215/xinwenfenleier/28.html"><img class="img-fluid" src="/static/default/assets/img/desk.jpg"></a></div>
                        <div class="col">
                            <h3 class="name">极致CMS新闻测试标题</h3>
                            <p class="description">极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新...</p>
                        </div>
			 ...
			 <nav>
				<ul class="pagination">
									<li class="page-item "><a class="page-link" href="" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
										<li class="page-item active background"><a href="http://10.119.9.215/index.php/Home/jizhi?page=1.html" class="page-link">1</a></li>
										<li class="page-item "><a href="http://10.119.9.215/index.php/Home/jizhi?page=2.html" class="page-link">2</a></li>
										<li class="page-item "><a href="http://10.119.9.215/index.php/Home/jizhi?page=3.html" class="page-link">3</a></li>
										<li class="page-item "><a href="http://10.119.9.215/index.php/Home/jizhi?page=4.html" class="page-link">4</a></li>
										<li class="page-item disabled"><a class="page-link" href="http://10.119.9.215/index.php/Home/jizhi?page=2.html" aria-label="Next"><span aria-hidden="true">»</span></a></li>
								</ul>
			</nav>
			</div>
            </div>
	...
	<div class="projects-horizontal">
                ...
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form action="http://10.119.9.215/search" method="GET">
	...
	<div class="projects-horizontal" style="margin-top:20px;">
                ...
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form action="http://10.119.9.215/searchAll" method="GET">
						<input name="molds[]" type="hidden" value="article" />
